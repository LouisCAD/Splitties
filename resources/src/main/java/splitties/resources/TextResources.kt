...
fun Context.styledTxt(@AttrRes attr: Int): CharSequence? = withStyledAttributes(attr) { getText(it) }
inline fun SupportFragment.styledTxt(@AttrRes attr: Int) = context!!.styledTxt(attr)
inline fun Fragment.styledTxt(@AttrRes attr: Int) = activity.styledTxt(attr)
...
inline fun SupportFragment.styledStr(@AttrRes attr: Int) = context!!.styledStr(attr)
inline fun Fragment.styledStr(@AttrRes attr: Int) = activity.styledStr(attr)
