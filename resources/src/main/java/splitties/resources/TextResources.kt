...
inline fun Fragment.qtyTxt(@PluralsRes stringResId: Int, quantity: Int) = context!!.qtyTxt(stringResId, quantity)
...
inline fun Fragment.qtyStr(@PluralsRes stringResId: Int, quantity: Int) = context!!.qtyStr(stringResId, quantity)
