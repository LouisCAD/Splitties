...
object Versions {
    ...
    const val splitties = "3.0.0-SNAPSHOT"
    ...
    object AndroidX {
        const val core = "1.0.0-rc02"
        const val lifecycle = "2.0.0-rc01"
        const val room = "2.0.0-rc01"
        const val paging = "2.0.0-rc01"
        const val slice = "1.0.0-rc02"
        const val multidex = "2.0.0"
        const val palette = "1.0.0-rc02"
        const val preference = "1.0.0-rc02"
        const val recyclerView = "1.0.0-rc02"
        const val sqlite = "2.0.0-rc01"
        const val vectorDrawable = "1.0.0-rc02"
        const val legacy = "1.0.0-rc02"
        const val leanback = "1.0.0-rc02"
        const val emoji = "1.0.0-rc02"
        const val constraintLayout = "1.1.2"
        const val collection = "1.0.0-rc02"
...
object Libs {
    ...
    object AndroidX {
        const val annotation = "androidx.annotation:annotation:1.0.0-rc02"
        const val appCompat = "androidx.appcompat:appcompat:1.0.0-rc02"
        const val asyncLayoutInflater = "androidx.asynclayoutinflater:asynclayoutinflater:1.0.0-rc02"
        const val browser = "androidx.browser:browser:1.0.0-rc02"
        const val car = "androidx.car:car:1.0.0-alpha5"
        const val cardView = "androidx.cardview:cardview:1.0.0-rc02"
        ...
        const val contentPager = "androidx.contentpager:contentpager:1.0.0-rc02"
        const val coordinatorLayout = "androidx.coordinatorlayout:coordinatorlayout:1.0.0-rc02"
        const val core = "androidx.core:core:${v.androidX.core}"
        const val coreKtx = "androidx.core:core-ktx:${v.androidX.core}"
        const val cursorAdapter = "androidx.cursoradapter:cursoradapter:1.0.0-rc02"
        const val customView = "androidx.customview:customview:1.0.0-rc02"
        const val documentFile = "androidx.documentfile:documentfile:1.0.0-rc02"
        const val drawerLayout = "androidx.drawerlayout:drawerlayout:1.0.0-rc02"
        const val dynamicAnimation = "androidx.dynamicanimation:dynamicanimation:1.0.0-rc02"
        ...
        const val exifInterface = "androidx.exifinterface:exifinterface:1.0.0-rc02"
        const val fragment = "androidx.fragment:fragment:1.0.0-rc02"
        const val fragmentKtx = "androidx.fragment:fragment-ktx:1.0.0-rc02"
        const val gridLayout = "androidx.gridlayout:gridlayout:1.0.0-rc02"
        const val heifWriter = "androidx.heifwriter:heifwriter:1.0.0-rc02"
        const val interpolator = "androidx.interpolator:interpolator:1.0.0-rc02"
        ...
        const val loader = "androidx.loader:loader:1.0.0-rc02"
        const val localBroadcastManager = "androidx.localbroadcastmanager:localbroadcastmanager:1.0.0-rc02"
        const val media = "androidx.media:media:1.0.0-rc02"
        ...
        const val percentLayout = "androidx.percentlayout:percentlayout:1.0.0-rc02"
        ...
        const val print = "androidx.print:print:1.0.0-rc02"
        const val recommendation = "androidx.recommendation:recommendation:1.0.0-rc02"
        ...
        const val slidingPaneLayout = "androidx.slidingpanelayout:slidingpanelayout:1.0.0-rc02"
        ...
        const val swipeRefreshLayout = "androidx.swiperefreshlayout:swiperefreshlayout:1.0.0-rc02"
        const val transition = "androidx.transition:transition:1.0.0-rc02"
        const val tvProvider = "androidx.tvprovider:tvprovider:1.0.0-rc02"
        ...
        const val versionedParcelable = "androidx.versionedparcelable:versionedparcelable:1.0.0-rc02"
        const val viewPager = "androidx.viewpager:viewpager:1.0.0-rc02"
        const val wear = "androidx.wear:wear:1.0.0-rc02"
        const val webkit = "androidx.webkit:webkit:1.0.0-rc02"
