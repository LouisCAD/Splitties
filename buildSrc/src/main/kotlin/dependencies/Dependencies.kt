...
/**
 * Please note that the versions here are a base version only
 * They are overriden by versions found in `gradle.properties`
 *
 * Those are generated and re-generated by the task
 *     `$./gradlew refreshVersions`
 *
 * Versions are overriden when one of those Gradle properties is found:
 *
