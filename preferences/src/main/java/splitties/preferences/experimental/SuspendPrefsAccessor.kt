 ...
 *
 * This class is meant to be a subclass of the `companion object` of your [Preferences] subclass.
 ...
 *
 * **IMPORTANT**: Make sure that your `Preferences` subclass constructor is private!
 */
