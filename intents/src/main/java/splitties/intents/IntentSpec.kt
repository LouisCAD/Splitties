...
interface BroadcastReceiverIntentSpec<T : BR, out ExtrasSpec : BundleSpec> : IntentSpec<T, ExtrasSpec>
...
inline fun <reified T : Activity> activityWithoutExtrasSpec() = object : ActivityIntentSpec<T, Nothing> {
    override val klass = T::class.java
...
inline fun <reified T : BR> receiverWithoutExtrasSpec() = object : BroadcastReceiverIntentSpec<T, Nothing> {
    override val klass = T::class.java
    override val extrasSpec get() = unsupported()
}
...
inline fun <reified T : Service> serviceWithoutExtrasSpec() = object : ServiceIntentSpec<T, Nothing> {
    override val klass = T::class.java
    override val extrasSpec get() = unsupported()
}
