...
object Concurrency {
    ...
    @JvmField
    internal val useStdlibIfUnchecked = appCtx.resources.getBoolean(R.bool.use_stdlib_if_unchecked)
    internal inline val useStdLibImpl get() = useStdlibIfUnchecked && unchecked
}